        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="font-heading text-5xl font-extrabold text-white mt-4 mb-5">
              Contact{" "}
              <span className="text-gradient-blue">Talent Connect India</span>
            </h1>
            <p className="text-slate-300 text-xl">
              Have a hiring requirement? Need help? We are here for you.
            </p>
          </motion.div>
        </div>
            ...
            <div className="space-y-6 mb-10">
              {[
                ...
                },
                {
                  icon: Mail,
                  label: "Email",
                  value: "info@talentconnectindia.com",
                ...
                },
                {
                  ...
                  label: "Head Office",
                  value:
                    "Talent Connect India, Shlok Apartment, near Dinosour Gardern, Pimple Gurav, Pune  -411061",
