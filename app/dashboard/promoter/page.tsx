      ...
      <div className="bg-linear-to-r from-amber-600 to-amber-500 text-white py-8 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <h1 className="font-heading text-3xl font-bold">Suresh Promoter</h1>
          </div>
          <div className="text-right">
            <p className="text-amber-100 text-xs mb-1">Total Earnings</p>
            <div className="font-heading text-3xl font-bold">₹7,300</div>
          </div>
        </div>
      </div>
