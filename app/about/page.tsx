...
const timeline = [
  {
    ...
    desc: "Talent Connect India was established with a vision to make quality hiring accessible to all businesses across India.",
  },
  {
    year: "2016",
    title: "100+ Placements",
    desc: "Crossed 100 successful placements and expanded to 5 major cities in India.",
  },
  {
    year: "2018",
    title: "AI Calling Launched",
    desc: "Introduced India's first AI-based calling system for automated candidate screening.",
  },
  {
    year: "2020",
    title: "135+ Cities Coverage",
    desc: "Expanded recruiter network to cover 135+ cities and 12 industry sectors.",
  },
  {
    year: "2022",
    title: "5000+ Placements",
    desc: "Crossed a major milestone of 5000+ successful placements with 99% employer satisfaction.",
  },
  {
    year: "2024",
    title: "₹199 Job Posting",
    desc: "Launched India's most affordable verified job posting solution at just ₹199.",
  },
];
...
const values = [
  {
    icon: Target,
    title: "Our Mission",
    desc: "To empower both talent and recruiters by simplifying the hiring process. We help Job Seekers find meaningful careers and Recruiters build elite teams through AI-driven accuracy and verified connections.",
    color: "text-blue-600",
    bg: "bg-blue-50",
  },
  {
    icon: Eye,
    title: "Our Vision",
    desc: "To create a seamless ecosystem where every career aspiration meets its perfect organizational match, bridging the gap between talent and opportunity across 135+ cities in India.",
  ...
  },
  {
    icon: Heart,
    title: "Our Values",
    desc: "Trust, Verified Quality, and Mutual Success. We believe in candidate dignity and recruiter efficiency, ensuring a fair, transparent, and high-speed recruitment experience for all.",
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          >
            {teamStats.map((s) => (
              ...
              >
                <s.icon
                  className={`w-8 h-8 ${s.color} mx-auto mb-3 group-hover:scale-110 transition-transform`}
                />
                <div
                  className={`font-heading text-4xl font-extrabold ${s.color}`}
                >
              ...
              {timeline.map((item, i) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span className="text-blue-600 font-bold text-sm font-heading">
                        {item.year}
                      </span>
                      <h4 className="font-heading font-bold text-slate-900 text-lg mt-1 mb-2">
                        {item.title}
                      </h4>
                      <p className="text-slate-500 text-sm leading-relaxed">
                        {item.desc}
